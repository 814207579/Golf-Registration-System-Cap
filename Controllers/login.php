        ...
        if($stmt = mysqli_prepare($link, $sql)){
            ...
            if(mysqli_stmt_execute($stmt)){
                ...
                if(mysqli_stmt_num_rows($stmt) == 1){                    
                    ...
                    mysqli_stmt_bind_result($stmt, $id, $username, $hashed_password, $access);
                    if(mysqli_stmt_fetch($stmt)){
                        if(password_verify($password, $hashed_password)){
							...
							//adding access to this
							$_SESSION["access"] = $access;
							
							//making tee time tables if login in proUser
							if($access === "Pro") {
								include_once("./../Models/AutoMakeNewTeeTimeTables.php");
							}
